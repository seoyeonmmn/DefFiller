...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=lambda x:x if type(x) == str and x.lower() != "none" else None,  default='./model_sem/sem_diffusion_pytorch_model.bin', 
    ...
    parser.add_argument("--total_iters", type=int,  default=30000, help="")
